...
function getWeather() {
    ...
    if (navigator.geolocation) {
        ...
        error.innerHTML = "Geoloaction API is not supported by this browser"
    }
}
...
async function fetchWeatherData(position) {
    try {
        ...
        const weatherInfo = `City: ${city}<br> Temperature: ${temperature}°C<br>Weather: ${weatherDescription}`;
        ...
        const errotext = document.getElementById('error');
        error.innerHTML = "failed to Fetch Error Data";
    }
